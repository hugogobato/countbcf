...
##  Outputs sim_zi__glm_zip__linear_zip_cate__N250_P5_ATE250.csv and sim_zi__glm_zip__linear_zip_cate__N250_P5_ATE250.log to the working directory.
################################################################################
...
OUT_CSV  <- "sim_zi__glm_zip__linear_zip_cate__N250_P5_ATE250.csv"
LOG_FILE <- "sim_zi__glm_zip__linear_zip_cate__N250_P5_ATE250.log"
