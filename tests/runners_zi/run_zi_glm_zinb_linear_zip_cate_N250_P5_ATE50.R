...
##  Outputs sim_zi__glm_zinb__linear_zip_cate__N250_P5_ATE50.csv and sim_zi__glm_zinb__linear_zip_cate__N250_P5_ATE50.log to the working directory.
################################################################################
...
OUT_CSV  <- "sim_zi__glm_zinb__linear_zip_cate__N250_P5_ATE50.csv"
LOG_FILE <- "sim_zi__glm_zinb__linear_zip_cate__N250_P5_ATE50.log"
