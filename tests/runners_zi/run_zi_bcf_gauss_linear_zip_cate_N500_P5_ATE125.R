...
##  Outputs sim_zi__bcf_gauss__linear_zip_cate__N500_P5_ATE125.csv and sim_zi__bcf_gauss__linear_zip_cate__N500_P5_ATE125.log to the working directory.
################################################################################
...
OUT_CSV  <- "sim_zi__bcf_gauss__linear_zip_cate__N500_P5_ATE125.csv"
LOG_FILE <- "sim_zi__bcf_gauss__linear_zip_cate__N500_P5_ATE125.log"
