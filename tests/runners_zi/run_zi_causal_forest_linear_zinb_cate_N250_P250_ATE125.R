...
##  Outputs sim_zi__causal_forest__linear_zinb_cate__N250_P250_ATE125.csv and sim_zi__causal_forest__linear_zinb_cate__N250_P250_ATE125.log to the working directory.
################################################################################
...
OUT_CSV  <- "sim_zi__causal_forest__linear_zinb_cate__N250_P250_ATE125.csv"
LOG_FILE <- "sim_zi__causal_forest__linear_zinb_cate__N250_P250_ATE125.log"
...
.f_tau_zi   <- function(X) -0.50 * X[, 1] + 0.30 * X[, 3] - 0.40 * X[, 4]
