...
##  Outputs sim_zi__causal_forest__nonlinear_zip_cate__N100_P5_ATE125.csv and sim_zi__causal_forest__nonlinear_zip_cate__N100_P5_ATE125.log to the working directory.
################################################################################
...
OUT_CSV  <- "sim_zi__causal_forest__nonlinear_zip_cate__N100_P5_ATE125.csv"
LOG_FILE <- "sim_zi__causal_forest__nonlinear_zip_cate__N100_P5_ATE125.log"
