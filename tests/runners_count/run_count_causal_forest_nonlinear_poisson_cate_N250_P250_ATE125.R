...
##  DGP     : nonlinear_poisson_cate
##  Cell    : N=250  P=250  ATE=1.25  (factor varied: P)
##  N_SIM   : 100 (seeds 1..100 are independent draws)
##
##  Only external dependency: library(countbart).
##  Outputs sim_count__causal_forest__nonlinear_poisson_cate__N250_P250_ATE125.csv and sim_count__causal_forest__nonlinear_poisson_cate__N250_P250_ATE125.log to the working directory.
################################################################################
...
METHOD       <- "causal_forest"
DGP_NAME     <- "nonlinear_poisson_cate"
FACTOR_VAR   <- "P"
N            <- 250L
P            <- 250L
ATE_TARGET   <- 1.25
...
OUT_CSV  <- "sim_count__causal_forest__nonlinear_poisson_cate__N250_P250_ATE125.csv"
LOG_FILE <- "sim_count__causal_forest__nonlinear_poisson_cate__N250_P250_ATE125.log"
