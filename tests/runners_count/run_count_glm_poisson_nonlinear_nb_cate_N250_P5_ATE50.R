...
##  Outputs sim_count__glm_poisson__nonlinear_nb_cate__N250_P5_ATE50.csv and sim_count__glm_poisson__nonlinear_nb_cate__N250_P5_ATE50.log to the working directory.
################################################################################
...
OUT_CSV  <- "sim_count__glm_poisson__nonlinear_nb_cate__N250_P5_ATE50.csv"
LOG_FILE <- "sim_count__glm_poisson__nonlinear_nb_cate__N250_P5_ATE50.log"
