...
##  Cell    : N=250  P=5  ATE=0.50  (factor varied: ATE)
##  N_SIM   : 100 (seeds 1..100 are independent draws)
##
##  Only external dependency: library(countbart).
##  Outputs sim_count__causal_forest__nonlinear_poisson_cate__N250_P5_ATE50.csv and sim_count__causal_forest__nonlinear_poisson_cate__N250_P5_ATE50.log to the working directory.
################################################################################
...
OUT_CSV  <- "sim_count__causal_forest__nonlinear_poisson_cate__N250_P5_ATE50.csv"
LOG_FILE <- "sim_count__causal_forest__nonlinear_poisson_cate__N250_P5_ATE50.log"
