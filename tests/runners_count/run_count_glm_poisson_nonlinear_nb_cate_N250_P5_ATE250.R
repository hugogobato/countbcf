...
##  Outputs sim_count__glm_poisson__nonlinear_nb_cate__N250_P5_ATE250.csv and sim_count__glm_poisson__nonlinear_nb_cate__N250_P5_ATE250.log to the working directory.
################################################################################
...
OUT_CSV  <- "sim_count__glm_poisson__nonlinear_nb_cate__N250_P5_ATE250.csv"
LOG_FILE <- "sim_count__glm_poisson__nonlinear_nb_cate__N250_P5_ATE250.log"
